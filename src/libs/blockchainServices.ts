...
export class GoldskyIndexer {
  static async getGuildLeaderboard(): Promise<Array<{
    ...
    return [
      { guildId: 1, name: "Crypto Legends", totalScore: 15420, ranking: 1, memberCount: 8, treasury: "2.4 MNT" },
      { guildId: 2, name: "DeFi Masters", totalScore: 13890, ranking: 2, memberCount: 7, treasury: "1.8 MNT" },
      { guildId: 3, name: "Blockchain Builders", totalScore: 12560, ranking: 3, memberCount: 9, treasury: "2.1 MNT" },
      { guildId: 4, name: "Web3 Warriors", totalScore: 11240, ranking: 4, memberCount: 6, treasury: "1.5 MNT" },
      { guildId: 5, name: "Smart Contract Pros", totalScore: 10180, ranking: 5, memberCount: 8, treasury: "1.9 MNT" },
      { guildId: 6, name: "NFT Collectors", totalScore: 9850, ranking: 6, memberCount: 5, treasury: "1.2 MNT" },
      { guildId: 7, name: "Mantle Champions", totalScore: 8920, ranking: 7, memberCount: 5, treasury: "0.8 MNT" },
      { guildId: 8, name: "Mantle Experts", totalScore: 7650, ranking: 8, memberCount: 4, treasury: "0.6 MNT" }
    ]
  }
